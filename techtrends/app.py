...
# Declare a global variable to store the number of database connections
...
def about():
    ## log line
    app.logger.info('About Us request successful')
...
if __name__ == "__main__":
   ...
   logging.basicConfig(handlers=[logging.StreamHandler(sys.stdout), logging.StreamHandler(sys.stderr)], level=logging.DEBUG)
